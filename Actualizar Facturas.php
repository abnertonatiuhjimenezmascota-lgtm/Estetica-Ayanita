...
$sql = "UPDATE facturas SET ID_Cliente = '$ID_Cliente', ID_Servicios = '$ID_Servicios', Fecha_factura = '$Fecha_factura', Cantidad_servicio = '$Cantidad_servicio', Costo_servicio = '$Costo_servicio', Total_ingreso = '$Total_ingreso' WHERE ID_Factura= $ID_Factura";
//Ejecutar e imformar
	if($conn->query($sql)){
